...
class VideoUploadTest extends BaseVideoTestCase
{
    ...
    public function test_file_urls_with_local_driver()
    {
        $fileFields = [];
    ...
    public function test_file_urls_with_gcs_driver()
    {
        $fileFields = [];
    ...
    public function test_file_urls_if_null_when_fields_are_null()
    {
        $video = Video::factory()->create();
